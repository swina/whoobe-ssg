...
const ICONIFY_URL = import.meta.env.VITE_APP_ICONIFY_QUERY
...
export function ObjectValueByKey ( key:String , obj:any ){
...
export function searchIconify ( search: String ){
    ...
    const resolve = new Promise ( (resolve,reject ) =>{
        fetch ( ICONIFY_URL + '?query=' + search + '&limit=' + limit , { mode: 'cors'})
        .then ( res => res.json() )
